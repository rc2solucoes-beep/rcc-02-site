      ...
      <section className="bg-rc2-bg py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-neutral max-w-none text-rc2-text/80 leading-relaxed space-y-8">
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">1. Aceitação dos termos</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">2. Sobre a RC2 Soluções</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">3. Uso permitido</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">4. Propriedade intelectual</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">5. Limitação de responsabilidade</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">6. Links externos</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">7. Privacidade</h2>
              <p>
                O tratamento de dados pessoais é regido pela nossa{" "}
                <a href="/privacidade" className="text-rc2-brand-text underline">Política de Privacidade</a>, em conformidade com a LGPD (Lei nº 13.709/2018) e o Marco Civil da Internet (Lei nº 12.965/2014).
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">8. Lei aplicável e foro</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-rc2-heading mb-3">9. Contato</h2>
              <p>
