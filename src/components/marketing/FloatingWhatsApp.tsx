...
export function FloatingWhatsApp() {
  return (
    <TrackedLink
      ...
      className="group fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-rc2-heading shadow-lg ring-1 ring-rc2-dark/5 transition-transform duration-200 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rc2-focus-ring focus-visible:ring-offset-2"
    >
